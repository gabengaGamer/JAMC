...
int jamc_ragdoll_convertation()
{
    ...
    verts = (struct MYRAGDOLLVERTEX *)malloc(sizeof(struct MYRAGDOLLVERTEX) * vert_cnt);
    fread(verts, 1, sizeof(struct MYRAGDOLLVERTEX)*vert_cnt, f_in);
